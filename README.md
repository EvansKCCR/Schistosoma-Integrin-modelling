...
```mermaid
flowchart TD
    A[Raw Sequence / Structure Data] --> B[01_extract_integrin_genes.py]
    B --> C[01_integrin_alpha_scan_and_classify.py]
    C --> D[01_integrin_alpha_beta_merged_pipeline.py]
    D --> E[02_batch_cif_to_pdb.py]
    E --> F[02_AF3_stats.py]
    F --> G[02_confidence_score_summary.py]
    G --> H[03_cluspro_mc_bayesian.py]
    H --> I[03_interface_benchmark_publication.py]
    I --> J[04_rank_integrin_binding.py]
    J --> K[05_residence_time_analysis_script.py]
    K --> L[05_generate_summary_and_plots.py]
    L --> M[03_generate_plots.py]

    subgraph Supporting Modules
        N[01_cobalt_integrin_beta_panels.py]
    end
